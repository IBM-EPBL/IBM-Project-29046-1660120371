...
axisBnkPnts = [[(1218, 70), (1540, 126), 'number', 'date'],
...
def crop(img, fname):
    ...
    myData = []
    for x, r in enumerate(axisBnkPnts):
        ...
        if r[2] == 'number':
            ...
            # gray = cv2.cvtColor(imgCrop, cv2.COLOR_BGR2GRAY)
            # cv2.imwrite('fileUpload/test/name.jpg', gray)
...
# fileName = '1.jpg'
# inp = cv2.imread("userCheque/" + fileName)
# print(crop(inp, fileName))
